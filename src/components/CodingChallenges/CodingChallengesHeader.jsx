    ...
    <div className='coding-challenges-container-header'>
      ...
      <div className="coding-challenges-filtering">
        ...
        <div className="filter-btns">
          <div className="fitler-btn-all coding-filter-btn" onClick={() => props.filterAll()}>All</div>
          ...
          <div className="fitler-btn-easy coding-filter-btn"
            onClick={(e) => props.filterDifficulty(e.target.textContent)}>Easy</div>
          <div className="fitler-btn-medium coding-filter-btn"
            onClick={(e) => props.filterDifficulty(e.target.textContent)}>Medium</div>
          <div className="fitler-btn-hard coding-filter-btn"
            onClick={(e) => props.filterDifficulty(e.target.textContent)}>Hard</div>
        </div>
      </div>
