...
function UserInfo(props) {
  ...
  let mentorRating, username, avatar, location;
  ...
  return (
    <Row>
      ...
      <Col breakPoint={{ xs: 6, sm: 6, md: 8, lg: 6 }}>
        <Row>
          {username ? <h4>Mentor Level</h4> : ""}
          {username ? <ProgressBar experience={mentorRating} /> : ""}
          {is_student ? <h4>Student Level</h4> : ""}
          {is_student ? <ProgressBar experience={studentRating} /> : ""}
