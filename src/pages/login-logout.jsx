...
export default function LoginLogout() {
  ...
  function login() {
    ...
    const userID = Number(document.querySelector('#login-user-id').selectedOptions[0].textContent);
    // console.log(document.querySelector('#login-user-id').selectedOptions[0])
